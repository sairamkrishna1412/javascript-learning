export const elements = {
    transactionType : document.querySelector('.add__type'),
    ...
    monthText : document.querySelector('.budget__title--month'),
    availableBudget : document.querySelector('.budget__value'),
    totalIncome : document.querySelector('.budget__income--value'),
    totalExpense : document.querySelector('.budget__expenses--value'),
    expTotalPercentage : document.querySelector('.budget__expenses--percentage'),
